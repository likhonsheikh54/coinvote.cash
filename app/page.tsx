...
export default function Home() {
  ...
  const websiteStructuredData = {
    ...
    "potentialAction": {
      ...
      "target": {
        "@type": "EntryPoint",
        "urlTemplate": "https://coinvote.cash/search?q={search_term_string}"
      },
      "query-input": "required name=search_term_string"
    },
    "description": "Discover and vote for the best cryptocurrencies. Track prices, market caps, and community activity in real-time.",
    "publisher": {
      "@type": "Organization",
      "name": "Coinvote.cash",
      "logo": {
        "@type": "ImageObject",
        "url": "https://coinvote.cash/logo.png"
      }
    }
  }
