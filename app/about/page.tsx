...
import { StructuredData, generateOrganizationStructuredData } from "@/lib/utils/structured-data"
...
export default function AboutPage() {
  ...
  const organizationData = generateOrganizationStructuredData({
    ...
    logo: "https://coinvote.cash/logo.png",
    description: "Coinvote.cash is a leading cryptocurrency aggregation platform, dedicated to spotlighting early-stage tokens, NFTs, and meme coins with high potential.",
    sameAs: [
      "https://twitter.com/coinvotecash",
      "https://t.me/coinvotecash",
      "https://github.com/coinvotecash",
      "https://medium.com/@coinvotecash"
    ]
  });
